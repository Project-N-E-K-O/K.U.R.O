...
{
    /// <summary>
    /// Enemy_Normal_guard3 专用 Spine 动画控制器，将动画与状态机/攻击模板绑定。
    /// </summary>
    public partial class EnemyNormalGuard3SpineAnimationController : EnemySpineAnimationController
    {
        ...
        private EnemyNormalGuard3AttackController? ResolveAttackController()
        {
            ...
            _attackController = GetNodeOrNull<EnemyNormalGuard3AttackController>(AttackControllerPath);
            if (_attackController == null)
            {
                _attackController = Enemy.GetNodeOrNull<EnemyNormalGuard3AttackController>(AttackControllerPath);
            }
        ...
        private bool IsExpectedHitAnimation(EnemyNormalGuard3AttackController controller, string animationName)
        {
